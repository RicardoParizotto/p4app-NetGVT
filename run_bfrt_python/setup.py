table1 = bfrt.NetGVTapp.pipe.SwitchIngress.ipv4_lpm
...
table2 = bfrt.NetGVTapp.pipe.SwitchIngress.eth_forward
entry = table2.entry_with_gvt_forward(src_addr=0x00154d1211a9 , dst_mac=0x00154d1211a9, port="132").push()

bfrt.NetGVTapp.pipe.LVT_pid_0.dump(from_hw=True)
bfrt.NetGVTapp.pipe.LVT_pid_1.dump(from_hw=True)
bfrt.NetGVTapp.pipe.GVT.dump(from_hw=True)

bfrt.NetGVTapp.pipe.LVT_pid_1.add(0, 100000)
bfrt.NetGVTapp.pipe.LVT_pid_2.add(0, 100000)
bfrt.NetGVTapp.pipe.LVT_pid_3.add(0, 100000)
bfrt.NetGVTapp.pipe.LVT_pid_4.add(0, 100000)
bfrt.NetGVTapp.pipe.LVT_pid_5.add(0, 100000)
bfrt.NetGVTapp.pipe.LVT_pid_6.add(0, 100000)
